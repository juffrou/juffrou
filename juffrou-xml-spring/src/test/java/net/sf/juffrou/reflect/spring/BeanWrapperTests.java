...
public final class BeanWrapperTests {
	...
	public void testStringArrayPropertyWithStringSplitting() throws Exception {
		PropsTester pt = new PropsTester();
		JuffrouSpringBeanWrapper bw = new JuffrouSpringBeanWrapper(pt);
	...
	public void testIntArrayProperty() {
		...
		assertTrue("correct values", pt.intArray[0] == 4 && pt.intArray[1] == 5 && pt.intArray[2] == 2
				&& pt.intArray[3] == 3);
	...
	public void testGetNestedPropertyNullValue() throws Exception {
		...
		try {
			...
			// ok
			assertTrue("it was the spouse.spouse property that was null, not " + ex.getPropertyName(), ex.getPropertyName().equals("spouse.spouse"));
		}
	}
	...
	public void testNullObject() {
		try {
			new JuffrouSpringBeanWrapper((Object) null);
